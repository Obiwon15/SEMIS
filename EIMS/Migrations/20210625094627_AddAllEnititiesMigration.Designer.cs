...
namespace EIMS.Migrations
{
    ...
    [Migration("20210625094627_AddAllEnititiesMigration")]
    partial class AddAllEnititiesMigration
    {
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 25, 10, 46, 26, 983, DateTimeKind.Local).AddTicks(2515));
