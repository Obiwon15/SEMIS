...
namespace EIMS.Migrations
{
    ...
    [Migration("20210629130605_ExamSubjectsManytoMany")]
    partial class ExamSubjectsManytoMany
    {
            ...
            modelBuilder.Entity("EIMS.Domain.Entities.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 6, 29, 14, 6, 0, 310, DateTimeKind.Local).AddTicks(4785));
